...
## Unresolved legacy source-identity queue
...
| Wotfard FS | Indian Type Foundry | https://www.fontshare.com/fonts/wotfard-fs | Open Source | Re-source from primary evidence |

## Current exact/reviewed Fontshare families

These families have current official API evidence and are handled by the Fontshare canonical evidence/runtime pipeline:
