    ...
    <div className="w-full min-h-screen bg-white text-black font-sans">
        ...
        <div className="sticky top-16 z-40 bg-white border-b border-neutral-200 px-6 py-6 flex justify-between items-end">
            ...
            <div className="flex flex-col items-end">
                 <button type="button" onClick={onGoToCatalog} className="flex items-center gap-2 hover:underline decoration-1 underline-offset-4 mb-2">
