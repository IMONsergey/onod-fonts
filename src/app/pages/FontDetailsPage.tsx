...
export const FontDetailsPage: React.FC<FontDetailsProps> = ({ font, onBack, toggleFavorite, isFavorite, toggleCompare, isCompare, testPairing, previewText }) => {
  ...
  const snippets = useMemo(() => ({
    import: sourceLabel === "Google Fonts" ? `@import url('${googleImportUrl(font)}');` : font.customCssUrl ? `@import url('${font.customCssUrl}');` : `/* Load ${font.name} from its verified source: ${sourceUrl} */`,
    css: `font-family: ${font.cssStack};`,
  }), [font, sourceLabel, sourceUrl]);
